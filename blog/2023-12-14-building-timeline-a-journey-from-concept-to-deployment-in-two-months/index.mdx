...
## Starting with Ideas: Using Figma

To make our idea real, we used Figma to draw our ideas. It was intuitive to learn, and we could change things quickly. This helped us make a plan for the basic version of our tool. We picked only the most important
features we needed to start using Timeline for our client projects. We wanted it to be focused on ease of use, simplicity, and productivity.
...
## Talking to Developers: We Need Your Help

Now that Timeline is out, we want to talk to developers. We need your thoughts. We want people to use Timeline early and tell us what they think. Timeline has lots of cool things, like shortcuts
and a way to change time entries easily. Right now, we are focused on providing a desktop web experience, with mobile coming later.
