...
We also provided <u>[a sample code](#sample-code)</u> which demonstrates how to implement this in a real-world-like scenario of Wiki page
management API.
