...
The time tracking tool we are talking about is online already today ([sheetty.com](https://sheetty.com)), but lately we worked on a very important feature.
...
And it’s live too, so go check it out [sheetty.com](https://sheetty.com)
## Next up
