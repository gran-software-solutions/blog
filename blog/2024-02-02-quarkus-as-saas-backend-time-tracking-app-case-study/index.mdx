...
One such tool we built for ourselves and others is a time-tracking application called <u>[Consulting Cockpit](https://consultingcockpit.com)</u>.
...
We invite you to try our time tracker at <u>[Consulting Cockpit](https://consultingcockpit.com)</u>.
